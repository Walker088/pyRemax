...
class PyremaxItem(scrapy.Item):
    ...
    postalInfo = scrapy.Field()

class MiticPostalItem(scrapy.Item):
    dpto = scrapy.Field()
    dpto_desc = scrapy.Field()
    distrito = scrapy.Field()
    dist_desc = scrapy.Field()
    barloc = scrapy.Field()
    barloc_desc = scrapy.Field()
    cod_post = scrapy.Field()
    barrio_polygon = scrapy.Field()
